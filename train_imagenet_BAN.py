...
from XNOR_Net_Plus_model import xnornetplus18_BAN

from util.progress.progress.bar import Bar as Bar

parser = argparse.ArgumentParser("xnornetplus18_BAN")
...
def main():
    ...
    checkpoint_tar = os.path.join(args.save, 'checkpoint_imagenet_BAN.pth.tar')
    ...
    while epoch < args.epochs:
        ...
        accuracy_file = open('imagenet_BAN_accuracy.txt', 'a')
