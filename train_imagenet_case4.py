...
from XNOR_Net_Plus_model import xnornetplus18_case4

from util.progress.progress.bar import Bar as Bar

os.environ['CUDA_VISIBLE_DEVICES'] = '1'  

parser = argparse.ArgumentParser("xnornetplus18_case4")
parser.add_argument('--batch_size', type=int, default=256, help='batch size')
parser.add_argument('--epochs', type=int, default=256, help='num of training epochs')
parser.add_argument('--learning_rate', type=float, default=4e-4, help='init learning rate')
...
def main():
    ...
    # load model
    model = xnornetplus18_case4().cuda()
    ...
    checkpoint_tar = os.path.join(args.save, 'model_best_imagenet_case4.pth.tar')
    ...
    while epoch < args.epochs:
        ...
        accuracy_file = open('imagenet_accuracy_case4.txt', 'a')
        ...
        #adjust_learning_rate_with_scheduler(optimizer, epoch, args)
